...
$p_dmg = $user['dmg'] + $run['buffs']['dmg'] + $eq_bonus['atk'] + $sb['atk'];
$p_def_base = $user['def'] + $run['buffs']['def'] + $eq_bonus['def'] + $sb['def'];
$p_max_hp_with_bonus = $user['max_hp'] + $eq_bonus['hp'] + $sb['hp'];
$p_crit_rate_eff = $p_crit_rate + $sb['crit'];
